...
#ifndef _CAM_VFE_LITE65X_H_
#define _CAM_VFE_LITE65X_H_
...
#define CAM_VFE_65X_NUM_DBG_REG 6

static struct cam_vfe_top_ver4_module_desc vfe65x_ipp_mod_desc[] = {
	{
		.id = 0,
		.desc = "CLC_BLS",
	},
...
static struct cam_vfe_top_ver4_wr_client_desc vfe650x_wr_client_desc[] = {
	{
		.wm_id = 0,
		.desc = "RDI_0",
	},
...
static struct cam_irq_register_set vfe65x_top_irq_reg_set[3] = {
	{
...
static struct cam_irq_controller_reg_info vfe65x_top_irq_reg_info = {
	.num_registers = 2,
	.irq_reg_set = vfe65x_top_irq_reg_set,
	.global_clear_offset  = 0x00001038,
	.global_clear_bitmask = 0x00000001,
	.clear_all_bitmask    = 0xFFFFFFFF,
};

static struct cam_vfe_top_ver4_reg_offset_common vfe65x_top_common_reg = {
	...
	.num_top_debug_reg        = CAM_VFE_65X_NUM_DBG_REG,
	.top_debug                = {
		0x0000105C,
		0x00001060,
		0x00001064,
...
static struct cam_vfe_ver4_path_reg_data vfe65x_ipp_reg_data =
{
	.sof_irq_mask                    = 0x1,
	.eof_irq_mask                    = 0x2,
	.error_irq_mask                  = 0x2,
...
static struct cam_vfe_ver4_path_reg_data vfe65x_rdi_reg_data[4] = {
...
static struct cam_vfe_ver4_path_hw_info
	vfe65x_rdi_hw_info[CAM_VFE_RDI_VER2_MAX] = {
	{
		.common_reg     = &vfe65x_top_common_reg,
		.reg_data       = &vfe65x_rdi_reg_data[0],
	},
	{
		.common_reg     = &vfe65x_top_common_reg,
		.reg_data       = &vfe65x_rdi_reg_data[1],
	},
	{
		.common_reg     = &vfe65x_top_common_reg,
		.reg_data       = &vfe65x_rdi_reg_data[2],
	},
	{
		.common_reg     = &vfe65x_top_common_reg,
		.reg_data       = &vfe65x_rdi_reg_data[3],
	},
};

static struct cam_vfe_top_ver4_debug_reg_info vfe65x_dbg_reg_info[CAM_VFE_65X_NUM_DBG_REG][8] = {
...
static struct cam_vfe_top_ver4_hw_info vfe65x_top_hw_info = {
	.common_reg = &vfe65x_top_common_reg,
	.rdi_hw_info[0] = &vfe65x_rdi_hw_info[0],
	.rdi_hw_info[1] = &vfe65x_rdi_hw_info[1],
	.rdi_hw_info[2] = &vfe65x_rdi_hw_info[2],
	.rdi_hw_info[3] = &vfe65x_rdi_hw_info[3],
	.vfe_full_hw_info = {
		.common_reg     = &vfe65x_top_common_reg,
		.reg_data       = &vfe65x_ipp_reg_data,
	},
	.ipp_module_desc        = vfe65x_ipp_mod_desc,
	.wr_client_desc         = vfe650x_wr_client_desc,
	.num_mux = 5,
	.mux_type = {
	...
	.debug_reg_info = &vfe65x_dbg_reg_info,
};

static struct cam_irq_register_set vfe650x_bus_irq_reg[1] = {
	{
...
static struct cam_vfe_bus_ver3_hw_info vfe650x_bus_hw_info = {
	.common_reg = {
	...
	.num_out = 7,
	.vfe_out_hw_info = { //TODO: camnoc sheet not updated yet for aurora, once updated check mid
		{
...
static struct cam_vfe_irq_hw_info vfe65x_irq_hw_info = {
	...
	.top_irq_reg   = &vfe65x_top_irq_reg_info,
};

static struct cam_vfe_hw_info cam_vfe_lite65x_hw_info = {
	.irq_hw_info                   = &vfe65x_irq_hw_info,

	.bus_version                   = CAM_VFE_BUS_VER_3_0,
	.bus_hw_info                   = &vfe650x_bus_hw_info,

	.top_version                   = CAM_VFE_TOP_VER_4_0,
	.top_hw_info                   = &vfe65x_top_hw_info,
};

#endif /* _CAM_VFE_LITE65X_H_ */
